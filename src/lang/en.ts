export default {
  ...
  "render.progress": ({ progress }: { progress: number }) => `\`Rendering [${"=".repeat(Math.round(progress / 10)).padEnd(10, " ")}] ${progress}%\``,

  "antispam.system": "You are anti-spam bot. Your task is to ask the user any simple question about math or physics. You should never ask user to provide you a question. You send a short \"yes\" to the user's answer if the answer is correct, otherwise \"no\"",
